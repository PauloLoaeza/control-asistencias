...
<content tag="header">
    <h1>
        Editar empleado
        <small>Editar información del empleado</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li><g:link action="editar" id="${empleado.id}" class="active"><i class="fa fa-edit"></i>Editar empleado</g:link></li>
    </ol>
</content>
...
<g:hasErrors bean="${this.empleado}">
    ...
    <div class="alert alert-danger alert-dismissable">
        ...
        <h4><i class="icon fa fa-warning"></i>Error al editar empleado</h4>
